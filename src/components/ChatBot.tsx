...
const RESPONSES_CLIENT: Response[] = [
  ...
  { keywords: ['courtage', 'financement', 'prêt', 'crédit', 'éco-ptz'],
    reply: "Notre service Assistance à maîtrise d'ouvrage vous aide à piloter, coordonner et suivre vos projets de travaux. Nos experts vous accompagnent de A à Z.",
    actions: [{ label: 'Assistance à maîtrise d\'ouvrage', href: '/services/courtage' }] },
